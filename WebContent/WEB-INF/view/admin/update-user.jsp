        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row bg-light rounded mx-0 p-2">
                  ...
                  <h5 class="mb-2 font-weight-bold text-primary">Cập nhật người dùng: ${userUpdate.username} </h5>
                  
                  <form:form action="updateUserProcess" modelAttribute="userUpdate" method="POST">
					...
					<form:hidden path="id" />
					  ...
					  <div class="col-md-6">
					    ...
					    <form:input path="fullName" cssClass="form-control" value="${userUpdate.fullName}" />
					    <form:errors path="fullName" cssClass="error" />
					  </div>
					  <div class="col-md-6">
					    <label class="form-label">Địa chỉ:</label>
					    <form:input path="address" cssClass="form-control" value="${userUpdate.address}" />
					    <form:errors path="address" cssClass="error" />
					  </div>
					  <div class="col-md-6">
					    <label class="form-label">Email:</label>
					    <form:input path="email" cssClass="form-control" value="${userUpdate.email}" readonly="true" />
					    <form:errors path="email" cssClass="error" />
					  </div>
					  <div class="col-md-6">
					    <label class="form-label">Số điện thoại:</label>
					    <form:input path="phoneNumber" cssClass="form-control" value="${userUpdate.phoneNumber}" />
					    <form:errors path="phoneNumber" cssClass="error" />
					  </div>
					  <div class="col-md-6">
					    <label class="form-label">Tài khoản:</label>
					    <form:input path="username" cssClass="form-control" value="${userUpdate.username}" readonly="true" />
					    <form:errors path="username" cssClass="error" />
					  </div>
					  
					  <form:hidden path="password" value="${userUpdate.password}" />
					  <form:hidden path="status" value="${userUpdate.status}" />
					  <form:hidden path="created" value="${userUpdate.created}" />
